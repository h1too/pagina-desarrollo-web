        ...
        <header class="row border-white border-2 border-bottom border-top">
            ...
            <div class="col-6 w-50 text-center align-self-center">
                <div class="btn-group btn-success col-8 text-white boton-nav shadow-sm">
                    <a href="<?php echo e(url('/usuario/index')); ?>" class="btn">Inicio / Home</a>
                    <a href="./contacto.html" class="btn">Contacto</a>
                    <a href="<?php echo e(url('/usuario/create')); ?>" class="btn">Registrarse</a>
...
</html><?php /**PATH C:\xampp\htdocs\pagina-desarrollo-web\Proyecto_Final\sistema\resources\views/usuario/index.blade.php ENDPATH**/ ?>