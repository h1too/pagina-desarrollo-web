        ...
        <main class="row text-white border-bottom border-white border-2 p-4 py-5">
            ...
            <div class="col-6 w-50 border rounded azulito p-5">
                ...
                <div class="col w-100 align-self-center d-flex">
                    <div class="col-6 w-50">
                        <img class="rounded-circle rounded-5 border border-3"
                            src="https://media.tenor.com/_CRKecwFC4kAAAAC/cyberpunk-edgerunners-rebecca.gif"
                            height="350px" alt="LuisitoPNG">
                    </div>
            ...
            <div class="col-6 w-50 border rounded azulito p-5">
                ...
                <div class="col w-100 d-flex">
                    <div class="col-6 w-50">
                        <img class="rounded-circle rounded-5 border border-3" src="Imagenes/Nosotros/auron.png" height="350px"
                            alt="AuronPNG">
                    </div>
                    <div class="col-6 w-50 align-self-center">
